...
public class Knight extends AbstractPlayerCharacter {
    ...
    /**
     * Creates a new character of the KNIGHT class.
     *
     * @param name
     *     the character's name
     */

    public Knight(@NotNull String name, int maxHealthPoints, int currentHealthPoints, int defensePoints) {
    ...
    public int equipWeapon(IWeapon weapon){
        int actionId = weapon.equipKnight(this);
        return actionId;
    }
